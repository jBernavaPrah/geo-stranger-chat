...
bot_messages = {"ask_delete_sure": gettext(
	...
	"download_file": gettext(
		"GeoStranger have sent a document. Click link to download it:\n\n%(file_url)s"),
	...
	"go_to_real_geostranger_account": gettext(
		"Hi. This is only an alias. Use @GeoStrangerBot instead. Thanks."),
				"help": gettext(
