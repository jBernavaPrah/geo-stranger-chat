...
welcome = u"*Welcome GeoStranger!* \U0001F600\U0001F600!\n\nIf you continue and answare my questions, you accept the terms of my creators (send me /terms to see its.).\nYou can delete all your information from my databases with command */delete*.\n\nFor the complete list of commands use */help*. \n\nTo send command simply click on button if present or send relative command with \"/\" in front. Example: \"/location\" ",

ask_location = u'To found best GeoStranger that match to you I need only one information, your current location. From where you write me?\n\n Enter the name of City and Region. *Nobody will know your real location.* GeoStranger will only see the name of your town/city.',
re_ask_location = u'Then, what is your current location?\n\n',
location_not_found = u"I haven't found {location_text}. Retry with other city or be more specific..",
location_error = u"I cannot continue if you not send me your position. What is your current location?",
...
search = u'To start new chat send me command /search.\n\nList of all commands /help.'
...
found_new_geostranger_first_time = u'Super! I have found your GeoStranger, near *{location_text}*. Now, all message, video, image or audio will be sent directly to this GeoStranger in anonymously mode. (Use /stop to stop receiving new GeoStrangers)',
found_new_geostranger = u'New GeoStranger, near *{location_text}*. Start chat with it. (Use /stop to stop receiving new GeoStrangers)'

ask_notify = u'Ok, now write your notification. :) I will send it to our developers!'
notify_sent = u'Notify sent!'
